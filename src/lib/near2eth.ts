//Copy-pasta from https://github.com/near/rainbow-bridge-lib/commit/c0bdf99df8a72122c655e60a4f2b34d0f4d37b4d 
// with some modifications to allow for a control variable for start/stop pattern 
...
const { RobustWeb3, sleep,  normalizeEthKey } = require('rainbow-bridge-lib/rainbow/robust')
...
export class Near2EthRelay {
   public robustWeb3:any;
   public web3:any;
   public ethMasterAccount: any;
   public near:any;
   public clientContract:any;
